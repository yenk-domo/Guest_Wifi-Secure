...
while ($true)
{
    ...
    if ($countfile -eq 1)
    {
        ...
        $date = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 1;
		(Get-Culture).textinfo.totitlecase([string]$date);
        $compagnyname = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 3;
		(Get-Culture).textinfo.totitlecase([string]$compagnyname.replace(' ',''));
		$numbercomputer = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 5;
		...
		[string]$Mail.replace(' ', '');
		[string]$serialbios = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 9;
		[string]$serial = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 11;
		[string]$computername = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 13;
		[string]$ip = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 15;
		[string]$Macadress = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 17;
		[string]$Macadress2 = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 18;
		[string]$Macadress3 = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 19;
		[string]$Macadress4 = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 20;
		[string]$Macadress5 = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 21;
		[string]$Macadress6 = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 22;
		[string]$Macadress7 = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 23;
		[string]$Macadress8 = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 24;
		[string]$Macadress9 = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 25;
		[string]$Macadress10 = Get-Content "C:\Users\admin\Desktop\FileFTP\WifiSecure\myCompagny.txt" | where { $_ -ne "$null" } | Select-Object -Index 26;
		...
		if ($checkserial -eq $false)
		{
			...
			#Send Email to myCompagny
			$OL = New-Object -ComObject outlook.application;
			Start-Sleep 5;
		
            #Create Item
			$mItem = $OL.CreateItem("olMailItem");
			$mItem.To = "exemple@mail.com";
			...
			$mItem.To = "$Mail";
			$mItem.Subject = "Inscription Valid";
			$mItem.Body = "You can Download your software in this link >>> ftp://GuestFTP:12345@<ExternalIP>/DownloadFile/SecureWifi.zip";
			$mItem.Send();
		}
		else
		{
